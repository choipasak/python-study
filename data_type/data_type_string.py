...
# 문자열 앞에 'r' 이라는 접두어를 붙이면 해당 문자열은 탈출 문자를 적용하지 않습니다.
print('===================================')
file2 = r'C:\temp\new.jpg'
print(file2)
...
# 어 근데 ''' ''' 이거 주석이자나
# 변수로 선언만 안하면 주석처럼 사용 가능 함! -> 파이썬은 문장 주석을 지원하지 않아서 이럼
...
'''
    ...
    - 곱셈 연산자(*)로 문자열을 정해진 수 만큼 번복해서 연결합니다.
'''
print('BaeGoPa' * 5) # 결과: BaeGoPaBaeGoPaBaeGoPaBaeGoPaBaeGoPa
print('=' * 40)

# print(s3 * 1.7) -> 곱하는 숫자는 정수만 가능. 실수 불가
