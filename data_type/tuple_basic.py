...
print('=' * 40)
tu = 1,3,5,7,9 # 이렇게 적어줘도 튜플로 세팅된다
print(tu)
...
1. 비용(데이터 사용량)의 차이: 리스트는 변경의 가능성을 항상 대비해야 하기 때문에
더 많은 메모리 공간을 차지하고, 속도도 그만큼 느립니다.
이에 비해, 튜플은 값의 집합만 표현할 뿐, 바뀔 일이 없으므로
내부 구조가 더 단순하고 속도(탐색의 속도)도 더 빠릅니다.
